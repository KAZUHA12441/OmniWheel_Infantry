...
void Chassis_RCDataHandle(Chassis_State State)
{
  ...
  case chassis_dreidel_on:
  {
    // 需要获取当前云台位置(编码器)
    // 底盘坐标系与云台坐标系的夹角
    cos_t = cos(OmniWheel_Chassis->Gimbal.Yaw_angle);
    sin_t = sin(OmniWheel_Chassis->Gimbal.Yaw_angle);
...
void Chassis_lock(void)
{
  ...
  OmniWheel_Chassis->Chassis.LB_Wheel.Motor_Data.speed_pid_out = Position_2_Speed_Pid(&OmniWheel_Chassis->Chassis.LB_Wheel.Pid_speed,
                                                                               &OmniWheel_Chassis->Chassis.LB_Wheel.Pid_position,
                                                                               0,
                                                                               OmniWheel_Chassis->Chassis.LB_Wheel.Motor_Data.Motor_Get.position_get,
                                                                               OmniWheel_Chassis->Chassis.LB_Wheel.Motor_Data.Motor_Get.speed_get);

  OmniWheel_Chassis->Chassis.LF_Wheel.Motor_Data.speed_pid_out = Position_2_Speed_Pid(&OmniWheel_Chassis->Chassis.LF_Wheel.Pid_speed,
                                                                               &OmniWheel_Chassis->Chassis.LF_Wheel.Pid_position,
                                                                               0,
                                                                               OmniWheel_Chassis->Chassis.LF_Wheel.Motor_Data.Motor_Get.position_get,
                                                                               OmniWheel_Chassis->Chassis.LF_Wheel.Motor_Data.Motor_Get.speed_get);

  OmniWheel_Chassis->Chassis.RB_Wheel.Motor_Data.speed_pid_out = Position_2_Speed_Pid(&OmniWheel_Chassis->Chassis.RB_Wheel.Pid_speed,
                                                                               &OmniWheel_Chassis->Chassis.RB_Wheel.Pid_position,
                                                                               0,
                                                                               OmniWheel_Chassis->Chassis.RB_Wheel.Motor_Data.Motor_Get.position_get,
                                                                               OmniWheel_Chassis->Chassis.RB_Wheel.Motor_Data.Motor_Get.speed_get);

  OmniWheel_Chassis->Chassis.RF_Wheel.Motor_Data.speed_pid_out = Position_2_Speed_Pid(&OmniWheel_Chassis->Chassis.RF_Wheel.Pid_speed,
                                                                               &OmniWheel_Chassis->Chassis.RF_Wheel.Pid_position,
                                                                               0,
                                                                               OmniWheel_Chassis->Chassis.RF_Wheel.Motor_Data.Motor_Get.position_get,
