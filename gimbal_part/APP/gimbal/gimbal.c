...
void GimbalControl(void)
{
    ...
    Gimbal_Struct->Gimbal.Gimbal_Yaw_Motor.Motor_Data.speed_pid_out = Position_2_Speed_Pid(&Gimbal_Struct->Gimbal.Gimbal_Yaw_Motor.Pid_position,
                                                                                             &Gimbal_Struct->Gimbal.Gimbal_Yaw_Motor.Pid_speed,
                                                                                              Gimbal_Struct->Gimbal.Yaw.Now_angle,
                                                                                              Gimbal_Struct->Gimbal.Yaw.Get_angle,
                                                                                              Gimbal_Struct->Gimbal.Gimbal_Yaw_Motor.Motor_Data.Motor_Get.speed_get);
    CheckOutput_Change();
}
